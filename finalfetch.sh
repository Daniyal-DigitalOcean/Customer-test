...
if [ -f /etc/ansible/facts.d/cloud_provider.fact ]; then
    ...
    case "$CLOUD_PROVIDER" in
        "amazon") echo "Cloud Provider: Amazon Web Services (AWS)" ;;
        "digitalocean") echo "Cloud Provider: DigitalOcean" ;;
        "google") echo "Cloud Provider: Google Cloud Platform (GCP)" ;;
        "azure") echo "Cloud Provider: Microsoft Azure" ;;
